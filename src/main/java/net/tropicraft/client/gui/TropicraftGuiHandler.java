...
public class TropicraftGuiHandler implements IGuiHandler {
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        if (id == 0) {
            ...
            return new ContainerBambooCraftingTable(player.inventory, world, new BlockPos(x, y, z));
        }
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        if (id == 0) {
            ...
            return new GuiBambooCraftingTable(player.inventory, world, new BlockPos(x, y, z));
        }
