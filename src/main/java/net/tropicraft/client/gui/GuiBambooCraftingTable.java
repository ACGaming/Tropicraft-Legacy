...
public class GuiBambooCraftingTable extends GuiContainer {
    ...
    public GuiBambooCraftingTable(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition) {
        super(new ContainerBambooCraftingTable(playerInv, worldIn, blockPosition));
    }
