...
public class ContainerBambooCraftingTable extends Container {
    ...
    public ContainerBambooCraftingTable(InventoryPlayer playerInventory, World worldIn, BlockPos posIn) {
        this.world = worldIn;
        this.pos = posIn;
