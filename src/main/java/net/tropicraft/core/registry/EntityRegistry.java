...
public class EntityRegistry {
    ...
    public static void init(RegistryEvent.Register<EntityEntry> event) {
        ...
        registerEntity(registry, EntityDart.class, "dart", 32, 1, true);
    ...
    private static void addSpawn(Class<? extends EntityLiving> entityClass, int weightedProb, int min, int max, EnumCreatureType creatureType, Biome...biomes) {
        net.minecraftforge.fml.common.registry.EntityRegistry.addSpawn(entityClass, weightedProb, min, max, creatureType, biomes);
    }
    ...
    private static Biome[] getOceanBiomes() {
        return new Biome[] {Biomes.OCEAN, Biomes.DEEP_OCEAN};
    }

    private static Biome[] getLandBiomes() {
        return new Biome[] {Biomes.BEACH, Biomes.DESERT, Biomes.JUNGLE, Biomes.JUNGLE_EDGE, Biomes.JUNGLE_HILLS,
                Biomes.MUTATED_JUNGLE, Biomes.MUTATED_JUNGLE_EDGE, Biomes.MESA, Biomes.MUTATED_SWAMPLAND,
                Biomes.SAVANNA, Biomes.SWAMPLAND
        };
    }

    private static Biome[] getJungleBiomes() {
        return new Biome[] {Biomes.JUNGLE, Biomes.JUNGLE_EDGE, Biomes.JUNGLE_HILLS, Biomes.MUTATED_JUNGLE,
